...
const routeConfig = getRedeemRouteConfigByKey(REDEEM_ROUTE_KEY.UAE);

export async function generateMetadata() {
  return buildRedeemRouteMetadata(routeConfig);
}

export default async function RedeemCodesUaePage({ searchParams = {} }) {
  ...
  const pageData = await getRedeemRoutePageData(REDEEM_ROUTE_KEY.UAE, {
    search,
    section
  });
