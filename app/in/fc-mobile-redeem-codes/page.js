...
const routeConfig = getRedeemRouteConfigByKey(REDEEM_ROUTE_KEY.INDIA);

export async function generateMetadata() {
  return buildRedeemRouteMetadata(routeConfig);
}

export default async function RedeemCodesIndiaPage({ searchParams = {} }) {
  ...
  const pageData = await getRedeemRoutePageData(REDEEM_ROUTE_KEY.INDIA, {
    search,
    section
  });
