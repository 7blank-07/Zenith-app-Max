...
function renderPlayerRow(player) {
  ...
  const priceMarkup = player.is_untradable
    ? `<img src="${escapeHtml(UNTRADABLE_FLAG_IMAGE_URL)}"
        alt="Non-auctionable"
  ...
  const untradableBadge = player.is_untradable
    ? `<div class="card-untradable-badge" style="pointer-events: none;"><img src="${escapeHtml(UNTRADABLE_BADGE_IMAGE_URL)}" alt="Untradable"></div>`
    : '';
