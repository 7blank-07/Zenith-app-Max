...
const routeConfig = getRedeemRouteConfigByKey(REDEEM_ROUTE_KEY.USA);

export async function generateMetadata() {
  return buildRedeemRouteMetadata(routeConfig);
}

export default async function RedeemCodesUsaPage({ searchParams = {} }) {
  ...
  const pageData = await getRedeemRoutePageData(REDEEM_ROUTE_KEY.USA, {
    search,
    section
  });
