...
const routeConfig = getRedeemRouteConfigByKey(REDEEM_ROUTE_KEY.GLOBAL_TODAY);

export async function generateMetadata() {
  return buildRedeemRouteMetadata(routeConfig);
}

export default async function RedeemCodesTodayPage({ searchParams = {} }) {
  ...
  const pageData = await getRedeemRoutePageData(REDEEM_ROUTE_KEY.GLOBAL_TODAY, {
    search,
    section
  });
